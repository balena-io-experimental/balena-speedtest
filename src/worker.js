...
var settings={
	...
	url_dl:"/dev/urandom", //path to a large file or garbage.php, used for download test. must be relative to this js file
	url_ul:"/dev/null", //path to an empty file, used for upload test. must be relative to this js file
	url_ping:"/dev/null", //path to an empty file, used for ping test. must be relative to this js file
